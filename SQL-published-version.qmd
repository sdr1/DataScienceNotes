...
| Function                                               | What does it do?              |
|:-------------------------|:---------------------------------------------|
| `to_char(trans_date, 'YYYY-MM')`                            | extracts year and month from a variable called trans\_date                |
| `extract('month' from trans\_date)`                            | extracts month from a variable called trans\_date                 |
